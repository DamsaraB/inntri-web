      ...
      <div className="container-custom">
        ...
        >
          <h2 className="text-3xl md:text-4xl font-heading font-bold text-gray-900 mb-4">
            Success <span className="text-gradient-neon">Stories</span>
          </h2>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 mb-12">
          {projects.map((project, index) => (
            ...
            >
              {/* Project Image */}
              <div className="relative mb-6 overflow-hidden rounded-2xl border border-gray-200 shadow-soft">
              ...
              <div className="space-y-4">
                <div>
                  <h3 className="text-2xl font-heading font-semibold text-gray-900 mb-2 group-hover:text-cyan-600 transition-colors duration-200">
                    {project.name}
                  </h3>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div className="bg-surface-muted p-4 rounded-lg border border-gray-100">
                ...
                <div>
                  ...
                  <div className="grid grid-cols-2 gap-2">
                    {project.results.map((result, resultIndex) => (
                      ...
                      >
                        <StarIcon className="w-4 h-4 text-cyan-500 mr-2 flex-shrink-0" />
                        {result}
                      </div>
                    ))}
                  </div>
                ...
                <div>
                  ...
                  <div className="flex flex-wrap gap-2">
                    {project.techStack.map((tech, techIndex) => (
                      <span
                        key={techIndex}
                        className="px-3 py-1 bg-surface-muted text-gray-600 text-xs rounded-full border border-gray-200"
                      >
                        {tech}
                      </span>
                    ))}
