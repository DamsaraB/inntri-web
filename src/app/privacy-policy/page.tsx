    ...
    <main className="min-h-screen bg-white">
      ...
      <section className="section-padding relative section-muted">
        <div className="container-custom max-w-4xl">
          ...
          >
            <h2 className="text-2xl font-heading font-semibold text-gray-900 mt-8 first:mt-0">
              1. Introduction
            </h2>
            ...
            <h2 className="text-2xl font-heading font-semibold text-gray-900 mt-8">
              2. Scope
            </h2>
            <p className="text-gray-500 leading-relaxed">
            ...
            <h3 className="text-xl font-heading font-medium text-cyan-600 mt-6">
              4.1 Users
            </h3>
            <ul className="list-disc pl-6 space-y-2 text-gray-500 leading-relaxed">
            ...
            <div className="text-gray-500 leading-relaxed space-y-1 pl-0">
              <p className="font-medium text-gray-900">S M N Prasanna</p>
